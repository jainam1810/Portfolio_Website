            ...
            <section id="experience" className="relative z-[2] py-24 px-6">
                <div className="max-w-[1100px] mx-auto">
                    ...
                    <div className="relative pl-8" style={{ borderLeft: '2px solid transparent', borderImage: 'linear-gradient(180deg,#38bdf8,#c084fc,#f472b6,#818cf8) 1' }}>
                        {[
                            { t: 'Software Engineer (Part-time)', c: 'Dizzy Otter Ltd', logo: '/dizzy-otter-logo.png', d: 'Feb 2026 - Present', l: 'Exeter, United Kingdom (Hybrid)', p: ['Build full-scale software products end-to-end from architecture and development to testing and deployment', 'Developing AI-powered categorisation and analysis features across multiple concurrent projects, leveraging Generative AI to accelerate delivery, running security and bug analysis to ensure client-safe and vulnerability-free output.', 'Co-ordinating directly with the CTO and clients to gather requirements, present project progress, incorporate feedback, and deliver high-quality solutions within tight timelines.'], tg: ['Full-Stack Development', 'AI orchestration', 'Typescript', 'Javascript Frameworks', 'Client Communication & Agile Delivery'] },
