                ...
                <div className="max-w-[1100px] mx-auto">
                    ...
                    <div data-reveal="hc" className={reveal('hc')} style={{ transitionDelay: '400ms' }}>
                        <div className="flex gap-3 justify-center flex-wrap mb-4">
                            <a href="https://drive.google.com/file/d/1yGlR7KL837Q-Iyi3Igc2dV9nhRr4udC_/view?usp=sharing" target="_blank" rel="noopener noreferrer" className="inline-flex flex-col items-center gap-0.5 px-6 py-3 rounded-xl font-semibold text-sm transition-all hover:-translate-y-0.5" style={{ background: 'linear-gradient(135deg,#38bdf8,#818cf8)', color: '#050a18', boxShadow: '0 4px 20px rgba(56,189,248,0.25)' }}>
                                <span className="inline-flex items-center gap-2"><Download size={16} /> AI/ML CV</span>
                                <span className="text-[10px] font-normal opacity-70">Last Updated - Jan 2026</span>
                            </a>
                            <a href="https://drive.google.com/file/d/1warqB-sx-OUkT_qfCYQF7qEgEWx7xak8/view?usp=sharing" target="_blank" rel="noopener noreferrer" className="inline-flex flex-col items-center gap-0.5 px-6 py-3 rounded-xl font-semibold text-sm text-slate-300 transition-all hover:-translate-y-0.5 hover:text-sky-400" style={{ border: '1px solid rgba(255,255,255,0.08)', backdropFilter: 'blur(8px)' }}>
                                <span className="inline-flex items-center gap-2"><Code size={16} /> Blockchain CV</span>
                                <span className="text-[10px] font-normal opacity-70">Last Updated - Jan 2026</span>
                            </a>
                        </div>
            ...
            <section id="experience" className="relative z-[2] py-24 px-6">
                <div className="max-w-[1100px] mx-auto">
                    ...
                    <div className="relative pl-8" style={{ borderLeft: '2px solid transparent', borderImage: 'linear-gradient(180deg,#38bdf8,#c084fc,#f472b6,#818cf8) 1' }}>
                        {[
                            { t: 'Software Engineer (Part-time)', c: 'Dizzy Otter Ltd', logo: '/dizzy-otter-logo.png', d: 'Feb 2026 - Present', l: 'Exeter, United Kingdom (Hybrid)', p: ['Build full-scale software products end-to-end from architecture and development to testing and deployment', 'Developing AI-powered categorisation and analysis features across multiple concurrent projects, leveraging Generative AI to accelerate delivery while refactoring AI-generated code - renaming variables and functions, adjusting syntax, and running security and bug analysis to ensure client-safe, vulnerability-free output.', 'Co-ordinating directly with the CTO and clients to gather requirements, present project progress, incorporate feedback, and deliver high-quality solutions within tight timelines.'], tg: ['Full-Stack Development', 'AI orchestration', 'Typescript', 'Javascript Frameworks', 'Client Communication & Agile Delivery'] },
            ...
            <section id="projects" className="relative z-[2] py-24 px-6">
                <div className="max-w-[1100px] mx-auto">
                    <div data-reveal="pt" className={reveal('pt')}>
                        ...
                        <p className="text-slate-500 text-sm mb-12 max-w-2xl">From AI-driven finance tools to decentralized applications (Checkout github for more recent projects)</p>
                    </div>
                ...
                <div className="max-w-[1100px] mx-auto">
                    ...
                    <div data-reveal="vo" className={`${glass} text-center mt-12 p-8 ${reveal('vo')}`}>
                        ...
                        <p className="mt-4 text-[11px] text-slate-500">
                            <span className="hidden md:inline">Press ↑ ↑ ↓ ↓ ← → ← → BA</span>
                            <span className="inline md:hidden">Tap 7 times on screen in 1.5 seconds</span>
                        </p>
                    </div>
                </div>
            </section>
