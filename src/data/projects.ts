...
export const projects: Project[] = [
  ...
  },
  {
    ...
    status: 'Live',
    summary:
      'The site you are reading. Five domains that re-theme every section at once, a headline that resizes itself so each version fills the same block, and a GitHub board pulled live on load.',
    impact:
      'The headline type scales are not hand-picked. A script measures each sentence against the real Anton font file and simulates the browser line breaking, so six sentences of different lengths fill one fixed strip and the page never shifts when you switch domain. Ships behind a Content-Security-Policy written from the origins the site actually requests, eight security headers, and no dependency vulnerabilities.',
    stack: [
      'React 19',
      'TypeScript',
      'Vite',
    ...
    links: [
      {
        label: 'GitHub',
        href: 'https://github.com/jainam1810/Portfolio_Website',
        kind: 'repo',
      },
    ],
  },
