...
export const domains: Record<DomainId, Domain> = {
  ...
  stack: {
    ...
    index: '03',
    label: 'Full-Stack',
    heroLine: 'the frontend and the backend of a product.',
    heroScale: { two: 0.09706, three: 0.12714 },
    ...
    proof: [
      ...
      'A 19-model Postgres schema behind row-level security and role-based access, with CI running lint, typecheck, tests, schema drift and build on every push',
    ],
  },
  ...
  fin: {
    ...
    index: '04',
    label: 'FinTech',
    heroLine: 'robust, tamper-proof fintech products.',
    heroScale: { two: 0.08703, three: 0.14248 },
